...
class tree_item : public object {
	struct ___method_bindings {
		...
		godot_method_bind *mb_get_button_by_id;
		godot_method_bind *mb_get_button_count;
		godot_method_bind *mb_get_button_id;
...
public:
	...
	// methods
	void add_button(const int64_t column, const ref<texture> button_, const int64_t id = -1, const bool disabled = false, const string tooltip = "");
	...
	int64_t get_button_by_id(const int64_t column, const int64_t id) const;
	int64_t get_button_count(const int64_t column) const;
	int64_t get_button_id(const int64_t column, const int64_t button_idx) const;
	string get_button_tooltip(const int64_t column, const int64_t button_idx) const;
	tree_item::TreeCellMode get_cell_mode(const int64_t column) const;
	tree_item *get_children();
	...
	tree_item *get_next();
	tree_item *get_next_visible(const bool wrap = false);
	tree_item *get_parent();
	tree_item *get_prev();
	tree_item *get_prev_visible(const bool wrap = false);
	...
	tree_item::TextAlign get_text_align(const int64_t column) const;
	...
	void set_button(const int64_t column, const int64_t button_idx, const ref<texture> button_);
	...
	void set_custom_bg_color(const int64_t column, const color color_, const bool just_outline = false);
	void set_custom_color(const int64_t column, const color color_);
	void set_custom_draw(const int64_t column, const object *object_, const string callback);
	...
	void set_icon(const int64_t column, const ref<texture> texture_);
