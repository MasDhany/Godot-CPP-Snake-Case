...
class visual_shader_node_color_func : public visual_shader_node {
...
public:
	...
	static visual_shader_node_color_func *_new();

	// methods
	visual_shader_node_color_func::Function get_function() const;
