...
class networked_multiplayer_peer : public packet_peer {
...
public:
	...
	// methods
	networked_multiplayer_peer::ConnectionStatus get_connection_status() const;
	int64_t get_packet_peer() const;
	networked_multiplayer_peer::TransferMode get_transfer_mode() const;
