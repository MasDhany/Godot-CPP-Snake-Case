...
class global_constants : public _Wrapped {
public: enum { ___CLASS_IS_SCRIPT = 0, };

private:
	static global_constants *_singleton;
...
public:
	...
	static inline global_constants *get_singleton()
	{
		if (!global_constants::_singleton) {
			global_constants::_singleton = new global_constants;
		}
		return global_constants::_singleton;
	}
	...
	const static int MIDI_MESSAGE_QUARTER_FRAME = 241;
	const static int MIDI_MESSAGE_SONG_POSITION_POINTER = 242;
	const static int MIDI_MESSAGE_SONG_SELECT = 243;
	const static int MIDI_MESSAGE_START = 250;
	const static int MIDI_MESSAGE_STOP = 252;
	const static int MIDI_MESSAGE_SYSTEM_EXCLUSIVE = 240;
	const static int MIDI_MESSAGE_SYSTEM_RESET = 255;
	const static int MIDI_MESSAGE_TIMING_CLOCK = 248;
	const static int MIDI_MESSAGE_TUNE_REQUEST = 246;
	...
	const static int PROPERTY_HINT_COLOR_NO_ALPHA = 22;
	const static int PROPERTY_HINT_DIR = 16;
	const static int PROPERTY_HINT_ENUM = 3;
	const static int PROPERTY_HINT_ENUM_SUGGESTION = 39;
	const static int PROPERTY_HINT_EXP_EASING = 4;
	const static int PROPERTY_HINT_EXP_RANGE = 2;
	const static int PROPERTY_HINT_FILE = 15;
	const static int PROPERTY_HINT_FLAGS = 8;
	const static int PROPERTY_HINT_GLOBAL_DIR = 18;
	const static int PROPERTY_HINT_GLOBAL_FILE = 17;
	const static int PROPERTY_HINT_IMAGE_COMPRESS_LOSSLESS = 24;
	const static int PROPERTY_HINT_IMAGE_COMPRESS_LOSSY = 23;
	const static int PROPERTY_HINT_KEY_ACCEL = 7;
	const static int PROPERTY_HINT_LAYERS_2D_NAVIGATION = 11;
	const static int PROPERTY_HINT_LAYERS_2D_PHYSICS = 10;
	const static int PROPERTY_HINT_LAYERS_2D_RENDER = 9;
	const static int PROPERTY_HINT_LAYERS_3D_NAVIGATION = 14;
	const static int PROPERTY_HINT_LAYERS_3D_PHYSICS = 13;
	const static int PROPERTY_HINT_LAYERS_3D_RENDER = 12;
	const static int PROPERTY_HINT_LENGTH = 5;
	const static int PROPERTY_HINT_MAX = 40;
	const static int PROPERTY_HINT_METHOD_OF_BASE_TYPE = 29;
	const static int PROPERTY_HINT_METHOD_OF_INSTANCE = 30;
	const static int PROPERTY_HINT_METHOD_OF_SCRIPT = 31;
	const static int PROPERTY_HINT_METHOD_OF_VARIANT_TYPE = 28;
	const static int PROPERTY_HINT_MULTILINE_TEXT = 20;
	const static int PROPERTY_HINT_NODE_PATH_TO_EDITED_NODE = 27;
	const static int PROPERTY_HINT_NODE_PATH_VALID_TYPES = 37;
	const static int PROPERTY_HINT_NONE = 0;
	const static int PROPERTY_HINT_OBJECT_ID = 25;
	const static int PROPERTY_HINT_OBJECT_TOO_BIG = 36;
	const static int PROPERTY_HINT_PLACEHOLDER_TEXT = 21;
	const static int PROPERTY_HINT_PROPERTY_OF_BASE_TYPE = 33;
	const static int PROPERTY_HINT_PROPERTY_OF_INSTANCE = 34;
	const static int PROPERTY_HINT_PROPERTY_OF_SCRIPT = 35;
	const static int PROPERTY_HINT_PROPERTY_OF_VARIANT_TYPE = 32;
	const static int PROPERTY_HINT_RANGE = 1;
	const static int PROPERTY_HINT_RESOURCE_TYPE = 19;
	const static int PROPERTY_HINT_SAVE_FILE = 38;
	const static int PROPERTY_HINT_TYPE_STRING = 26;
