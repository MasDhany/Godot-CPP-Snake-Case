...
class visual_shader_node_expression : public visual_shader_node_group_base {
...
public:
	...
	static visual_shader_node_expression *_new();

	// methods
	string get_expression() const;
	void set_expression(const string expression_);
