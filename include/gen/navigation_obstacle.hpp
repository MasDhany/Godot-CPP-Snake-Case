#ifndef GODOT_CPP_NAVIGATIONOBSTACLE_HPP
#define GODOT_CPP_NAVIGATIONOBSTACLE_HPP
...
class navigation_obstacle : public node {
...
public:
	...
	static inline const char *___get_class_name() { return (const char *) "NavigationObstacle"; }
	static inline const char *___get_godot_class_name() { return (const char *) "NavigationObstacle"; }
	...
	static navigation_obstacle *_new();
