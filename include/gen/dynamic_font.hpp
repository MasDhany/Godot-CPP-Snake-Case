...
class dynamic_font_data;

class dynamic_font : public font {
...
public:
	...
	static dynamic_font *_new();

	// methods
	void add_fallback(const ref<dynamic_font_data> data);
	string get_available_chars() const;
	ref<dynamic_font_data> get_fallback(const int64_t idx) const;
	int64_t get_fallback_count() const;
	ref<dynamic_font_data> get_font_data() const;
	...
	void set_fallback(const int64_t idx, const ref<dynamic_font_data> data);
	void set_font_data(const ref<dynamic_font_data> data);
	void set_outline_color(const color color_);
