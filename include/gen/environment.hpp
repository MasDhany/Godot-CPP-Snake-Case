...
class environment : public resource {
	struct ___method_bindings {
		...
		godot_method_bind *mb_is_glow_high_quality_enabled;
		...
		godot_method_bind *mb_set_glow_high_quality;
...
public:
	...
	void set_ambient_light_color(const color color_);
	...
	void set_fog_color(const color color_);
	void set_fog_depth_begin(const real_t distance);
	void set_fog_depth_curve(const real_t curve_);
	...
	void set_fog_height_curve(const real_t curve_);
	...
	void set_fog_sun_color(const color color_);
	void set_fog_transmit_curve(const real_t curve_);
	...
	void set_sky(const ref<sky> sky_);
	...
	void set_ssao_color(const color color_);
