...
class visual_shader_node_vector_op : public visual_shader_node {
...
public:
	...
	static visual_shader_node_vector_op *_new();

	// methods
	visual_shader_node_vector_op::Operator get_operator() const;
