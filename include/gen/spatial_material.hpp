...
class spatial_material : public material {
	struct ___method_bindings {
		...
		godot_method_bind *mb_get_async_mode;
		...
		godot_method_bind *mb_set_async_mode;
...
public:
	...
	spatial_material::TextureChannel get_ao_texture_channel() const;
	spatial_material::AsyncMode get_async_mode() const;
	spatial_material::BillboardMode get_billboard_mode() const;
	spatial_material::BlendMode get_blend_mode() const;
	real_t get_clearcoat() const;
	real_t get_clearcoat_gloss() const;
	spatial_material::CullMode get_cull_mode() const;
	...
	spatial_material::DepthDrawMode get_depth_draw_mode() const;
	real_t get_depth_scale() const;
	spatial_material::BlendMode get_detail_blend_mode() const;
	spatial_material::DetailUV get_detail_uv() const;
	spatial_material::DiffuseMode get_diffuse_mode() const;
	spatial_material::DistanceFadeMode get_distance_fade() const;
	...
	spatial_material::EmissionOperator get_emission_operator() const;
	...
	spatial_material::TextureChannel get_metallic_texture_channel() const;
	...
	spatial_material::TextureChannel get_refraction_texture_channel() const;
	real_t get_rim() const;
	real_t get_rim_tint() const;
	real_t get_roughness() const;
	spatial_material::TextureChannel get_roughness_texture_channel() const;
	real_t get_specular() const;
	spatial_material::SpecularMode get_specular_mode() const;
	...
	void set_async_mode(const int64_t mode);
	...
	void set_texture(const int64_t param, const ref<texture> texture_);
