...
class physics2_dshape_query_parameters;

class physics2_ddirect_space_state : public object {
...
public:
	...
	// methods
	array cast_motion(const ref<physics2_dshape_query_parameters> shape_);
	array collide_shape(const ref<physics2_dshape_query_parameters> shape_, const int64_t max_results = 32);
	dictionary get_rest_info(const ref<physics2_dshape_query_parameters> shape_);
	...
	array intersect_shape(const ref<physics2_dshape_query_parameters> shape_, const int64_t max_results = 32);
