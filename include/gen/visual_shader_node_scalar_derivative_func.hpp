...
class visual_shader_node_scalar_derivative_func : public visual_shader_node {
...
public:
	...
	static visual_shader_node_scalar_derivative_func *_new();

	// methods
	visual_shader_node_scalar_derivative_func::Function get_function() const;
