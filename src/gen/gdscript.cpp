...
void gdscript::___init_method_bindings() {
	___mb.mb_get_as_byte_code = gd::api->godot_method_bind_get_method("GDScript", "get_as_byte_code");
	___mb.mb_new = gd::api->godot_method_bind_get_method("GDScript", "new");
	godot_string_name class_name;
	gd::api->godot_string_name_new_data(&class_name, "GDScript");
...
{
	return (gdscript *) gd::nativescript_1_1_api->godot_nativescript_get_instance_binding_data(gd::_RegisterState::language_index, gd::api->godot_get_class_constructor((char *)"GDScript")());
}
pool_byte_array gdscript::get_as_byte_code() const {
