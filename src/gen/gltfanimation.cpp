...
void gltfanimation::___init_method_bindings() {
	___mb.mb_get_loop = gd::api->godot_method_bind_get_method("GLTFAnimation", "get_loop");
	___mb.mb_set_loop = gd::api->godot_method_bind_get_method("GLTFAnimation", "set_loop");
	godot_string_name class_name;
	gd::api->godot_string_name_new_data(&class_name, "GLTFAnimation");
...
{
	return (gltfanimation *) gd::nativescript_1_1_api->godot_nativescript_get_instance_binding_data(gd::_RegisterState::language_index, gd::api->godot_get_class_constructor((char *)"GLTFAnimation")());
}
